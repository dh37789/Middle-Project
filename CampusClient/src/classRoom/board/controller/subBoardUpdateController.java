...
public class subBoardUpdateController {
    ...
    void update(ActionEvent event) throws IOException {
    	...
    	vo.setHwbd_id(this.vo.getHwbd_id());
    	if (tfFrt.getText()==null || tfFrt.getText().isEmpty()) {
    		vo.setHwbd_frt("");
    		tfFrt.setText("");
		}else {
			vo.setHwbd_frt(tfFrt.getText());
		}
    	String oldPath = vo.getHwbd_frt();
    	...
    	int cnt = service.upHBoard(vo);
    	if (cnt > 0) {
    		if (oldPath.equals(tfFrt.getText())) {
    ...
    @FXML
    void initialize() {
        assert pane != null : "fx:id=\"pane\" was not injected: check your FXML file 'subBoardUpdate.fxml'.";
        assert tfTi != null : "fx:id=\"tfTi\" was not injected: check your FXML file 'subBoardUpdate.fxml'.";
        assert comSub != null : "fx:id=\"comSub\" was not injected: check your FXML file 'subBoardUpdate.fxml'.";
        assert taCon != null : "fx:id=\"taCon\" was not injected: check your FXML file 'subBoardUpdate.fxml'.";
        assert tfFrt != null : "fx:id=\"tfFrt\" was not injected: check your FXML file 'subBoardUpdate.fxml'.";
        assert btnFileUp != null : "fx:id=\"btnFileUp\" was not injected: check your FXML file 'subBoardUpdate.fxml'.";
        assert btnUp != null : "fx:id=\"btnUp\" was not injected: check your FXML file 'subBoardUpdate.fxml'.";
        assert btnCancel != null : "fx:id=\"btnCancel\" was not injected: check your FXML file 'subBoardUpdate.fxml'.";
        Registry reg;
        try {
    ...
    public void viewBoard() {
		...
		comSub.setValue(vo.getHwbd_sub());
	}
