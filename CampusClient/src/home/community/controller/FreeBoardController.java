...
public class FreeBoardController {
    ...
    //등록 버튼을 눌러 새글을 작성
    @FXML
    void frbd_write(ActionEvent event) throws IOException {
    	FXMLLoader loader = new FXMLLoader(getClass().getResource("community_freeBoard_write.fxml"));
    	Parent root = loader.load();
    	
    	FreeBoard_WriteController wrController = loader.getController();
    	wrController.setMvo(mvo);
    ...
    void initialize() throws RemoteException, NotBoundException {
        ...
        assert btn_add != null : "fx:id=\"btn_add\" was not injected: check your FXML file 'community_freeBoard.fxml'.";
        assert tf_search != null : "fx:id=\"tf_search\" was not injected: check your FXML file 'community_freeBoard.fxml'.";
        assert label != null : "fx:id=\"label\" was not injected: check your FXML file 'community_freeBoard.fxml'.";
		...
		btn_add.setFocusTraversable(false);
    }
    ...
    private void paging(){
    	int pageCount = fbSize / rowPerPage + 
				(fbSize%rowPerPage==0 ? 0 : 1);
